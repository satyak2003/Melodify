...
private val MelodifyDarkColors = darkColorScheme(
    ...
    surface = Color(0x40121212),            // Elevated translucent surface (black/dark gray)
    onSurface = Color(0xFFF3F2F8),          // High contrast bright white
    surfaceVariant = Color(0x661E1E1E),     // Distinct translucent card surface (dark gray)
    onSurfaceVariant = Color(0xFFBAC0DA),   // Crisp readable slate gray
    surfaceContainer = Color(0x401A1A1A),
